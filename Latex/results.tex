...
\begin{figure}[h]
    ...
    \begin{subfigure}[b]{0.5\textwidth}
	    ...
	    \input{images/effects_linear_time.tex}
	    \caption{travel time}
	\end{subfigure}
	%\par\medskip
    \begin{subfigure}[b]{0.5\textwidth}
	    \setlength{\abovecaptionskip}{1pt plus 3pt minus 0pt}
	    \input{images/effects_linear_jerk.tex}
   	    \caption{jerk}
	\end{subfigure}
...
\begin{table}[h!]
	...
	%\thickline
	\input{tables/anova_linear_time.tex}
	\end{tabular}
	...
	\begin{tabular}{l r r r r r}
	%\thickline
	\input{tables/anova_linear_mod_time.tex}	
	\end{tabular}
...
\begin{figure}
    \centering
    \setlength{\abovecaptionskip}{1pt plus 3pt minus 0pt}
	\input{images/interpol_lin1.tex}
...
\begin{table}[h!]
	...
	\begin{tabular}{l r r r r r}
	%\thickline
	\input{tables/anova_linear_jerk.tex}
	\end{tabular}
	...
	\begin{tabular}{l r r r r r}
	%\thickline	
	\input{tables/anova_linear_mod_jerk.tex}	
	\end{tabular}
...
\begin{figure}[h]
    ...
    \begin{subfigure}[b]{0.5\textwidth}
	    \setlength{\abovecaptionskip}{1pt plus 3pt minus 0pt}
	    \input{images/effects_linear_interactions_time.tex}
	    \caption{travel time}
	\end{subfigure}
    \begin{subfigure}[b]{0.5\textwidth}
		\setlength{\abovecaptionskip}{1pt plus 3pt minus 0pt}	
	    \input{images/effects_linear_interactions_jerk.tex}
   	    \caption{jerk}
	\end{subfigure}
...
\begin{table}[h!]
	...
	\begin{tabular}{l r r r r r}
	%\thickline
	\input{tables/anova_linear_interactions_time.tex}
	\end{tabular}
	...
	\begin{tabular}{l r r r r r}
	%\thickline	
	\input{tables/anova_linear_interactions_mod_time.tex}	
	\end{tabular}
...
\begin{table}[h!]
	...
	\begin{tabular}{l r r r r r}
	%\thickline
	\input{tables/anova_linear_interactions_jerk.tex}
	\end{tabular}
...
\begin{figure}[h]
    ...
    \begin{subfigure}[b]{0.5\textwidth}
	    \setlength{\abovecaptionskip}{1pt plus 3pt minus 0pt}
	    \input{images/effects_quadr_time.tex}
	    \caption{travel time}
	\end{subfigure}
    \begin{subfigure}[b]{0.5\textwidth}
		\setlength{\abovecaptionskip}{1pt plus 3pt minus 0pt}	
	    \input{images/effects_quadr_jerk.tex}
   	    \caption{jerk}
	\end{subfigure}
...
\begin{table}[h!]
	...
	\begin{tabular}{l r r r r r}
	%\thickline
	\input{tables/anova_quadratic_time.tex}
	\end{tabular}
	...
	\begin{tabular}{l r r r r r}
	%\thickline	
	\input{tables/anova_quadratic_mod_time.tex}	
	\end{tabular}
...
\begin{table}[h!]
	...
	\begin{tabular}{l r r r r r}
	%\thickline
	\input{tables/anova_quadratic_jerk.tex}
	\end{tabular}
	...
	\begin{tabular}{l r r r r r}
	%\thickline	
	\input{tables/anova_quadratic_mod_jerk.tex}	
	\end{tabular}

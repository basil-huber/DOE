...
bar([1 3 4],m(4).resp(j).effects/m(i).resp(j).effects(1),width1/2,'FaceColor',[0,0.7,0.7])
        ...
        xlabel('coefficients')
        ylabel('ai/ao')
print_plot_latex('images/effects_linear_time.tex')
...
bar([1 3 4],m(4).resp(j).effects/m(i).resp(j).effects(1),width1/2,'FaceColor',[0,0.7,0.7])
        ...
        xlabel('coefficients')
        ylabel('bi/bo')
print_plot_latex('images/effects_linear_jerk.tex');
...
bar([1 3 4 7],m(5).resp(j).effects/m(5).resp(j).effects(1),width1/2,'FaceColor',[0,0.7,0.7])
        ...
        xlabel('coefficients')
        ylabel('ai/ao')
print_plot_latex('images/effects_linear_interactions_time.tex');
...
bar([1 3 4],m(4).resp(j).effects/m(4).resp(j).effects(1),width1/2,'FaceColor',[0,0.7,0.7])
        ...
        xlabel('coefficients')
        ylabel('bi/bo')
print_plot_latex('images/effects_linear_interactions_jerk.tex');
...
bar([1:5 7:10],m(6).resp(j).effects/m(6).resp(j).effects(1),width1/2,'FaceColor',[0,0.7,0.7])
        ...
        xlabel('coefficients')
        ylabel('ai/ao')
print_plot_latex('images/effects_quadr_time.tex');
...
bar([1:5 8:10],m(7).resp(j).effects/m(7).resp(j).effects(1),width1/2,'FaceColor',[0,0.7,0.7])
        ...
        xlabel('coefficients')
        ylabel('bi/bo')
print_plot_latex('images/effects_quadr_jerk.tex');
return
%% ----------------------
% create ANOVA tables
% ----------------------
...
ylim([0 3])
print_plot_latex('images/fitLin_time.tex');

plot_interpolation(m(4), e, 2)
print_plot_latex('images/fitLin_jerk.tex');
%return
...
pause
print_plot_latex('images/interpol_lin1.tex');
figure
